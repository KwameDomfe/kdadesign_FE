...
const HomePageNext = () => {
  return (
    <div>
        <header id="homePage_the_next--header"
            className="container container90 container80-m
                w-60-m 
                ph2-00-m pv4-00 
                tc"
        >
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <figcaption className="container container90 container80-m
                            gc1s1 gr1s1"
                        >
                            <h3 className="mb2-00
                                fw6 f2-00 f2-50-s f3-00-m f4-00-l "
                            >
            ...
            <section id="homePage_our_purpose"
                className="grid gtc12 mb4-00"
            >
